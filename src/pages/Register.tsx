		...
		<>
			<div className="flex relative  z-10 min-h-full flex-1 flex-col justify-center py-6 sm:px-6 lg:px-8">
				...
				<div className="mt-4 sm:mx-auto sm:w-full sm:max-w-[480px]">
					<div className="bg-white dark:bg-zinc-900 px-6 py-10 shadow sm:rounded-lg sm:px-12">
						<form
							ref={registerForm}
						...
						>
							...
							<div>
								<Button color={"violet"} type={"submit"} className={"w-full"}>
									Register
								</Button>
							</div>
						</form>
						...
						<div>
							<div className="relative mt-6">
								...
								<div className="relative flex justify-center text-sm  font-medium leading-6">
									<span className=" rounded-md px-6 text-black bg-zinc-50 dark:bg-zinc-700 dark:text-white">
										Or continue with
									</span>
								</div>
							</div>
